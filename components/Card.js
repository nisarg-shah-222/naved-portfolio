export default function Card({ image, title, info }) {
  return (
    <div className="group relative w-full aspect-square rounded-lg overflow-hidden flex flex-col justify-between hover:shadow-2xl transition-shadow duration-300">
      ...
      <div className="flex justify-between items-center text-xs text-[#d4d4d4] px-4 pb-4">
